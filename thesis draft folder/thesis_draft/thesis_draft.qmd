...
+ **Sample Size:** $n \in \{100, 250, 600\}$ representing small, moderate and larger 
datasets. 

+ **Variance:** $\sigma^2 \in \{0.2, 0.4, 0.6, 0.8\}$ ranging from well-separated 
...
For this simulation, we want to explore if the CRAB algorithm is able to correctly
identify the true underlying structure. Though $k = 3$ is a good baseline to test,
it's important that CRAB is able to capture the correct $k$ for a multitude of $k$.
Here, we test CRAB's ability to identify k = 2, 3, and 4.
...
k2 <- read_csv(here::here("thesis draft folder", "csv",
                           "simulations", "k_crab2.csv"), na = character())
k2_2 <- read_csv(here::here("thesis draft folder", "csv",
                           "simulations", "k_crab2_2.csv"), na = character())
k2_3 <- read_csv(here::here("thesis draft folder", "csv",
                           "simulations", "k_crab2_3.csv"), na = character())
...
k2_mult <- read_csv(here::here("thesis draft folder", "csv",
                           "simulations", "k_crab_mult2.csv"), na = character())
...
ggplot(aes(x = k, y = Score, color = source)) +
  geom_line() +
  geom_point() +
  labs(title = "Individual Seeds for CRAB Score When k = 2", 
       color = "",
       y = "") +
...
k3 <- read_csv(here::here("thesis draft folder", "csv",
                           "simulations", "k_crab3.csv"), na = character())
k3_2 <- read_csv(here::here("thesis draft folder", "csv",
                           "simulations", "k_crab3_2.csv"), na = character())
k3_3 <- read_csv(here::here("thesis draft folder", "csv",
                           "simulations", "k_crab3_3.csv"), na = character())
...
k3_mult <- read_csv(here::here("thesis draft folder", "csv",
                           "simulations", "k_crab_mult3.csv"), na = character())
...
ggplot(aes(x = k, y = Score, color = source)) +
  geom_line() +
  geom_point() +
  labs(title = "Individual Seeds for CRAB Score When k = 3", 
       color = "",
       y = "") +
  scale_color_brewer(palette = "Set2") +
  theme_bw() +
...
k4 <- read_csv(here::here("thesis draft folder", "csv",
                           "simulations", "k_crab4.csv"), na = character())
k4_2 <- read_csv(here::here("thesis draft folder", "csv",
                           "simulations", "k_crab4_2.csv"), na = character())
k4_3 <- read_csv(here::here("thesis draft folder", "csv",
                           "simulations", "k_crab4_3.csv"), na = character())
...
k4_mult <- read_csv(here::here("thesis draft folder", "csv",
                           "simulations", "k_crab_mult4.csv"), na = character())
